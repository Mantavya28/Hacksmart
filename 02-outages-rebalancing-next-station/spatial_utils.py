...
def find_optimal_station_location(existing_stations, boundary_file='delhi_boundary.geojson', grid_resolution=0.02):
    ...
    try:
        ...
        # Calculate original demand indices for existing stations (before adding new station)
        print("Calculating original demand indices for existing stations...")
        original_geojson = generate_voronoi_polygons(existing_stations)
        original_demand_indices = {}
        if original_geojson and 'features' in original_geojson:
            for feature in original_geojson['features']:
                ...
                original_demand_indices[station_id] = demand_idx
        ...
        if best_location:
            ...
            return {
                ...
                'original_demand_indices': original_demand_indices,
