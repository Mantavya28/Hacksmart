...
# Logo path
logo_path = "hacksmart_demo2/greenswap_logo.png"
...
if page == "Dashboard Home":
    ...
    st.plotly_chart(generate_demand_curve(None, hours_limit=selected_hours), use_container_width=True, config={'displayModeBar': False})
