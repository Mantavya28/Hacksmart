...
from battery_simulation import get_day7_wait_time, get_day7_lost_swap_pct, get_day7_charger_util, get_day7_total_cost, BatterySimulation, DEFAULT_STATIONS_DATA
import json
...
def initialize_delhi_stations() -> List[Dict]:
    ...
    Returns the embedded DEFAULT_STATIONS_DATA from battery_simulation.py.
    """
    # Use the single source of truth from battery_simulation.py
    print(f"Loaded {len(DEFAULT_STATIONS_DATA)} stations from embedded data.")
    return DEFAULT_STATIONS_DATA
